Login.widgets = {
	main_layout: ["wm.Layout", {"height":"100%","verticalAlign":"top","autoScroll":false}, {}, {
		panel1: ["wm.Panel", {"height":"324px","width":"100%","horizontalAlign":"center","verticalAlign":"top","layoutKind":"left-to-right"}, {}],
		loginMainPanel: ["wm.Panel", {"height":"353px","horizontalAlign":"center","layoutKind":"left-to-right","padding":"10"}, {}, {
			...
			loginInputPanel: ["wm.Panel", {"_classes":{"domNode":["wm_Border_StyleFirefoxCurved4px","wm_Border_StyleSolid","wm_Border_Size1px","wm_Border_ColorLightGray","wm_FontSizePx_14px","wm_Border_TopStyleCurved8px","wm_Border_BottomStyleCurved8px","wm_BackgroundColor_White"]},"height":"254px","width":"366px","border":"1","padding":"10","borderColor":"#bbb"}, {}, {
				...
				loginButtonPanel: ["wm.Panel", {"height":"39px","horizontalAlign":"right","layoutKind":"left-to-right","padding":"4"}, {}, {
					loginButton: ["wm.Button", {"_classes":{"domNode":["wm_FontFamily_Arial","wm_Border_TopStyleCurved8px","wm_Border_BottomStyleCurved8px","wm_FontColor_White","wm_FontSizePx_12px","wm_BackgroundColor_White"]},"height":"100%","width":"80px","border":"0","margin":"0","caption":"Acceder"}, {"onclick":"loginButtonClick"}]
				}],
		...
		footer: ["wm.Layers", {"_classes":{"domNode":["wm_SilverBlueTheme_ToolBar","wm_FontSizePx_12px"]},"height":"45px"}, {}, {
			layer1: ["wm.Layer", {"caption":"layer1","horizontalAlign":"left","verticalAlign":"top"}, {}, {
				panel2: ["wm.Panel", {"_classes":{"domNode":["wm_BackgroundColor_White"]},"height":"100%","width":"100%","horizontalAlign":"center","verticalAlign":"top","layoutKind":"left-to-right"}, {}, {
					label1: ["wm.Label", {"height":"100%","width":"100%","border":"0","align":"center","caption":"Colegio Rochester  © Apredoz - 2014-2015"}, {}, {
						format: ["wm.DataFormatter", {}, {}]
					}]
				}]
			}]
